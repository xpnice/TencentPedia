  ...
  data () {
    return {
      ...
      cards: [
        {
          id: 1,
          avotor: 'https://alcdn.img.xiaoka.tv/20191102/60e/f5c/1321259173/60ef5c1e1124a5e54eff70893398aa63.jpg@1e_1c_0o_0l_96h_96w_100q_1pr.webp',
          title: 'IMWeb前端一面',
          author: '朱一旦',
          content: '网盘项目怎么实现大文件上传和多用户上传【chunk】怎么记录用户登录态 【没用cookie\\session\\token等后端无状态，前端通过redux+ 路由】XSS和CSRF是什么，怎么避免网盘后端你做了什么工作\r\nwebpack说说看',
          fav: true,
          fav_num: 100,
          com_num: 99,
          star: true,
        ...
        {
          id: 2,
          avotor: 'https://cdn.vuetifyjs.com/images/john.jpg',
          title: 'WXG支付后台',
          author: '啊吗粽',
